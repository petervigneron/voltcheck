...
## Not every Bolt EV can DC fast charge
...
- Range added in about 30 minutes, from a depleted battery, in GM's own words:
  ...
  - 2023: "up to 100 miles of driving range can be added for Bolt EV, and up to 95 miles for Bolt EUV, in approximately 30 minutes," on a station with at least 150 amps of available current.[^7]
- GM states the charge does not stop at that point: "Charging will continue to 100% at a gradually slower rate as the battery fills up."[^7]
- GM's own caution on cold weather: "Charging speed will vary significantly based on the outside temperature."[^7]
...
- 2022 Bolt EUV, from GM's own table:
  - 120 volts, 8 amps: about 2.8 miles per hour of charge, about 79 hours to full.
  - 120 volts, 12 amps: about 4 miles per hour of charge, about 55 hours to full.
  - 240 volts, 32 amps: about 25 miles per hour of charge, about 10 hours to full. GM's footnote calls 32 amps the "Dual Level Charge Cord maximum."
...
- Chevrolet states that Bolt EV customers can charge at a Tesla Supercharger with GM's NACS DC adapter.[^8] The car still needs the DC fast-charging hardware described above; the adapter does not add it.
- Chevrolet has a specific warning for two model years: "Chevrolet has informed owners of select 19MY and 20MY Chevrolet Bolt EVs of a new software update which will assist with securing the lock in the charge port while using an adapter." Chevrolet directs those owners to a dealer service appointment.[^8]
- The NACS DC adapter's MSRP is $225, with a 12-month limited warranty from the date of purchase.[^8]
- It does not work on Level 2 Tesla chargers. Chevrolet's words: "No. The NACS DC adapter is a DC adapter designed exclusively for safe use with Tesla Superchargers only."[^8]
...
The 2027 Chevrolet Bolt is a different generation on a different platform and is outside this sheet's scope.
