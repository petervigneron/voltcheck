...
export const RESEARCH_ROWS_3: EnrichmentRow[] = [
  ...
  // ---------------------------------------------------------------------
  {
    id: "mache-2022-premium-rwd",
    make: "FORD",
    model: "Mustang Mach-E",
    modelYears: [2022, 2022],
    trim: "Premium",
    drive: "RWD",
    battery: { chemistry: f("NMC", "mfr", "high", "2022 predates the MY2023 mid-year Standard Range chemistry switch — every 2022 Standard Range pack is NMC, no LFP split exists for this model year") },
    range: { epaRangeMi: f(247, "mfr", "high", "MY2022 Standard Range RWD — EPA", "https://www.fueleconomy.gov") },
    charging: {
    ...
    buyerNotes: [
      ...
      },
      {
        ...
        body: "Ford states connected services are available for a minimum of seven years from the vehicle's new-vehicle warranty start date; for a 2022 model that typically means service ends around 2029.",
        severity: "info",
      },
    ],
  },
